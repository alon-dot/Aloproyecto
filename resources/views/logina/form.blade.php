                    ...
                    <div class="text-center mt-5">
                        ...
                        <ul class="list-inline">
                            <li class="list-inline-item">
                                <span class="badge badge-warning">Alta Precisión</span>
                            </li>
                            <li class="list-inline-item">
                                <span class="badge badge-secondary">Reducción de Errores Humanos</span>
                            </li>
                            <li class="list-inline-item">
                                <span class="badge badge-warning">Mayor Productividad</span>
                            </li>
                            <li class="list-inline-item">
                                <span class="badge badge-secondary">Menor Tiempo de Producción</span>
                            </li>
                        </ul>
                    </div>
