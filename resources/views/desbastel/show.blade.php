            ...
            <div class="col-md-12">
                <div class="card shadow-lg border-warning">
                    <div class="card-header bg-warning text-dark" style="display: flex; justify-content: space-between; align-items: center;">
                        <h5 class="card-title mb-0 text-dark">{{ __('Detalles del Desbastel') }}</h5>
                    ...
                    <div class="card-body bg-light">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <strong class="text-dark">{{ __('Diametro Herramienta:') }}</strong>
                                    <p class="form-control-plaintext">{{ $desbastel->diametro_herramienta }}</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <strong class="text-dark">{{ __('Numero Dientes:') }}</strong>
